...
Code, OpenAI Codex, Cursor, VS Code and other agents that read `SKILL.md`.
...
skills/
├── business/
│   └── company-research/     profile any company, not only an employer
└── careers/
    ├── role-fit/             does this background match this job?
    ├── pay-check/            what the role is worth, and what to say
    └── interview-prep/       orchestrator; calls the other three by name
```
